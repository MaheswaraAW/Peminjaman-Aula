                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" name="username"
                                        value="{{ $pengguna->username }}" required=""></textarea>
                                </div>
                                <!-- <label>Password</label> -->
                                <div id="idpass" class="form-group has-feedback">
                                    <input type="text" class="form-control" name="password"
                                        value="{{ $pengguna->password }}" required="" readonly></textarea>
                                </div>
                                <label>Bidang</label>
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control"
                                        value="{{ $pengguna->ref_bidang->detail_bidang }}" readonly disabled></input>
                                </div>
                                <label>Sub Koord</label>
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control"
                                        value="{{ $pengguna->ref_seksi != null ? $pengguna->ref_seksi->detail_seksi : '-' }}"
                                ...
                                <div id="idrlevel" class="form-group has-feedback">
                                    <label class="mr-2">
                                        <input type="radio" name="level" value="0" <?php if ($pengguna->level == '0') {
                                            echo 'checked';
                                        } ?>>Admin
                                    </label>

                                    <label class="mr-2">
                                        <input type="radio" name="level" value="1" <?php if ($pengguna->level == '1') {
                                            echo 'checked';
                                        } ?>>User
                                    </label>
                                </div>
