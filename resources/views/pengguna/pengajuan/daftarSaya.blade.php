                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto ml-auto">
                            <li class="nav-item" id="idsemua">
                                <a class="nav-link" href="{{ url('pengajuan/daftarsaya/semua') }}"
                                    id="idasemua">SEMUA</a>
                            </li>
                            <li class="nav-item" id="idhariini">
                                <a class="nav-link" href="{{ url('pengajuan/daftarsaya/hariini') }}"
                                    id="idahariini">HARI INI</a>
                            </li>
                            <li class="nav-item" id="idbulanini">
                                <a class="nav-link" href="{{ url('pengajuan/daftarsaya/bulanini') }}"
                                    id="idabulanini">BULAN INI</a>
                            </li>
                            <li class="nav-item" id="idtahunini">
                                <a class="nav-link" href="{{ url('pengajuan/daftarsaya/tahunini') }}"
