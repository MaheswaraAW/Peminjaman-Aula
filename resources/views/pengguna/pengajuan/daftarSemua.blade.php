                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto ml-auto">
                      <li class="nav-item" id="idsemua">
                        <a class="nav-link" href="{{url('pengajuan/daftarsemua/semua')}}" id="idasemua">SEMUA</a>
                      </li>
                      <li class="nav-item" id="idhariini">
                        <a class="nav-link" href="{{url('pengajuan/daftarsemua/hariini')}}" id="idahariini">HARI INI</a>
                      </li>
                      <li class="nav-item" id="idbulanini">
                        <a class="nav-link" href="{{url('pengajuan/daftarsemua/bulanini')}}" id="idabulanini">BULAN INI</a>
                      </li>
                      <li class="nav-item" id="idtahunini">
                        <a class="nav-link" href="{{url('pengajuan/daftarsemua/tahunini')}}" id="idatahunini">TAHUN INI</a>
                      </li>
                    </ul>
