                            ...
                            <div class="col-md-8">
                                ...
                                {{-- <div class="form-group has-feedback">
                                    ...
                                    <select name="bidang" id="bidang" onchange="ocbidang(this.value)">
                                        ...
                                        <option value="Pencegahan Pemberantasan Penyakit">Pencegahan Pemberantasan
                                            Penyakit</option>
                                ...
                                {{-- <div class="form-group has-feedback">
                                    ...
                                    <select name="seksi" id="seksi">
                                        ...
                                        <option value="-">-</option>
                                        <!-- kesmas -->
                                        <option value="Seksi Kesehatan Ibu dan Anak">Seksi Kesehatan Ibu dan Anak
                                        </option>
                                        <option value="Seksi Kesehatan Lingkungan dan Promosi Kesehatan">Seksi
                                            Kesehatan Lingkungan dan Promosi Kesehatan</option>
                                        <option value="Seksi Pemberdayaan Masyarakat dan Gizi">Seksi Pemberdayaan
                                            Masyarakat dan Gizi</option>
                                        <!-- Pencegahan Pemberantasan Penyakit -->
                                        <option value="Seksi P2 Tular Vektor dan Zoonotik">Seksi P2 Tular Vektor dan
                                            Zoonotik</option>
                                        <option value="Seksi P2 Tidak Menular dan Surveilans">Seksi P2 Tidak Menular
                                            dan Surveilans</option>
                                        <option value="Seksi P2 Penyakit Menular Langsung">Seksi P2 Penyakit Menular
                                            Langsung</option>
                                        <!-- Sumber Daya Kesehatan -->
                                        <option value="Seksi Kefarmasian dan Perbekalan Kesehatan">Seksi Kefarmasian
                                            dan Perbekalan Kesehatan</option>
                                        <option value="Seksi Sumber Daya Manusia Kesehatan">Seksi Sumber Daya Manusia
                                            Kesehatan</option>
                                        <option value="Seksi Informasi dan Pengendalian Sarana Kesehatan">Seksi
                                            Informasi dan Pengendalian Sarana Kesehatan</option>
                                        <!-- sekretariat -->
                                        <option value="Sub bag Perencanaan dan Evaluasi">Sub bag Perencanaan dan
                                            Evaluasi</option>
                                        ...
                                        <!-- pelayanan kesehatan -->
                                        <option value="Seksi Pelayanan Kesehatan Primer dan Tradisional">Seksi
                                            Pelayanan Kesehatan Primer dan Tradisional</option>
                                        <option value="Seksi Pelayanan Kesehatan Rujukan">Seksi Pelayanan Kesehatan
                                            Rujukan</option>
                                        <option value="Seksi Jaminan Kesehatan dan Kemitraan">Seksi Jaminan Kesehatan
                                            dan Kemitraan</option>
                                    </select>
                                </div> --}}
