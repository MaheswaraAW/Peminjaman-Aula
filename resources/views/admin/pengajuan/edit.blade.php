...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="{{url('pengajuan/update', $pengajuan->id)}}" method="post" >
      ...
      <div class="row">
        <div class="col">
          <input type="hidden" class="form-control" name="id" placeholder="id" required="" value="{{$pengajuan->id}}">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="acara"  required="" value="{{$pengajuan->acara}}">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="form-group">
            <input type="date" class="form-control" name="tanggal" required="" value="{{$tgl2}}" id="tanggal" onchange="cek()">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="form=group">
              <div class="row form-group">
                ...
                <div class="col input-group date" id="jam_mulai" data-target-input="nearest" onchange="cek()">
                    <input type="text" class="form-control datetimepicker-input" data-target="#jam_mulai" name="jam_mulai" id="jam_m" value="{{$pengajuan->jam_m}}"/>
                ...
                <div class="col input-group date" id="jam_selesai" data-target-input="nearest" onchange="cek()">
                    <input type="text" class="form-control datetimepicker-input" data-target="#jam_selesai" name="jam_selesai" id="jam_s" value="{{$pengajuan->jam_s}}"/>
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="bidang" required="" value="{{$pengajuan->bidang}}">
          </div>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="seksi"  required="" value="{{$pengajuan->seksi}}">
          </div>
          <div class="form-group has-feedback">
            <input type="hidden" class="form-control" name="pemesan" required="" value="{{$pengajuan->pemesan}}">
          </div>
          <div class="form-group has-feedback">
