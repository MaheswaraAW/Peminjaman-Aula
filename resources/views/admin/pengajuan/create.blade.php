      ...
      <form action="{{route('pengajuan/simpan')}}" method="post" >
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <label>Tanggal</label>
            <div class="form-group has-feedback">
              <input type="date" class="form-control" name="tanggal" id="tanggal" required="" onchange="cek()">
            </div>
            <div class="form=group">
              <div class="row form-group">
                ...
                <div class="col input-group date" id="jam_mulai" data-target-input="nearest" onchange="cek()">
                    <input type="text" class="form-control datetimepicker-input" data-target="#jam_mulai" name="jam_mulai" id="jam_m"  />
                ...
                <div class="col input-group date" id="jam_selesai" data-target-input="nearest" onchange="cek()">
                    <input type="text" class="form-control datetimepicker-input" data-target="#jam_selesai" name="jam_selesai" id="jam_s"/>
            ...
            <div class="form-group has-feedback">
              <input type="hidden" class="form-control" name="pemesan" placeholder="Pemesan" required="" value="{{$pengguna->username}}">
            </div>
