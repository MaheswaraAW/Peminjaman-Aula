...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo mb-5">
            <center>
                <p><b>
                        <font color="black">{{ config('app.name') }}</font>
                    </b>
                </p>
                <img width="200px" height="150px" src="{{ asset('logo_dinkes_semarang.png') }}"><br>
                <h6 class="mt-2">{{ config('app.detail') }}</h6>
            </center>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body mt-3">
            @if (isset($user_pass_error))
                <div style="display:flex; justify-content: center; color: red; font-weight: bold;">{{ $user_pass_error }}
                </div>
            @endif
